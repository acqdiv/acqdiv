...
''' Script to calcualte the age of the participants from a csv-file, prints output to another csv-file.
    ...
    Usage: $python3 get_ages.py <inputfile.csv> <outputfile.csv>
...
if len(sys.argv) > 2:
    ...
    print('\nPlease indicate the infile and outfile as command line arguments.\n')
    ...
    for i in range(0,len(line)):
        if column_names2[i] == "age":
            try:
                ...
                line.insert(int(i),age_at_rec_date)
            except ValueError:
