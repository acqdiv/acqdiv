...
if __name__=="__main__":
    input = sys.argv[1] # input diretory
    output = sys.argv[2] # output directory
    main(input, output, notes) # directory of replacement and metadata tables

# python3 clean.py <input dir> <output dir> <notes dir>
# python3 clean.py turkish/andreas/ turkish/andreas-gold/ turkish/notes/
