...
morphemes <- morphemes %>% rename(morpheme_id=id, morpheme_language=language, morpheme_type=type)
...
utterances_slim <- utterances %>% select(utterance_id, session_id_fk, utterance_id_source, corpus, language, speaker_id_fk, addressee, childdirected, utterance, translation, utterance_morphemes, start, end, comment, warning)
