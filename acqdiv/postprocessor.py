...
def postprocess(test=False):
    ...
    if test:
        ...
        print('python3 -m "nose" -s -w tests '
              'test_integrity.py:ValidationTest_DevDB')
    else:
        print('python3 -m "nose" -s -w tests '
              'test_integrity.py:ValidationTest_ProductionDB')
    print()
...
def _update_rows(t, binder, rows):
    ...
    Bindparameter and list of dictionaries contain column-value mappings.
    """
