...
class XMLTestCree(unittest.TestCase):
    ...
    def test_morphemes(self):
        ...
        result_cree = session.execute(s_cree)
        self.assertEqual(str(result_cree.fetchall()), "[(1, 'Cree', 'u700', None, 'Cree', 'Cree', 'target', 'ˈmin', 'again', 'again', 'p,quant', None), (2, 'Cree', 'u700', None, 'Cree', 'Cree', 'target', 'ˈɡa', 'also', 'also', 'p,conj', None), (3, 'Cree', 'u700', None, 'Cree', 'Cree', 'target', 'ə̃ˈhə̃', 'yes', 'yes', 'p,aff', None), (4, 'Cree', 'u701', None, 'Cree', 'Cree', 'target', 'ˈɡa', 'also', 'also', 'p,conj', None), (5, 'Cree', 'u705', None, 'Cree', 'Cree', 'target', 'ˈmin', 'again', 'again', 'p,quant', None), (6, 'Cree', 'u705', None, 'Cree', 'Cree', 'target', 'ˈɡa', 'also', 'also', 'p,conj', None), (7, 'Cree', 'u707', None, 'Cree', 'Cree', 'target', 'ˈmaw', 'here.it.is', 'here.it.is', 'p,dem', None), (8, 'Cree', 'u706', None, 'Cree', 'Cree', 'target', 'tʰu', 'two', 'two', 'Eng', None), (9, 'Cree', 'u703', None, 'Cree', 'Cree', 'target', 'ˈtʰivi', 'tv', 'tv', 'Eng', None)]")
